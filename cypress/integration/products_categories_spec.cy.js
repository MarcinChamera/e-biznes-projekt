describe('Products & Categories', function () {
    ...
    it('Products url should redirect to the same page as the default one', () => {
        ...
        cy.get('.categoriesCombobox').should('be.visible');
    })
    ...
    it('"telefony" category should have its description visible', () => {
        ...
        cy.waitUntil(() => cy.get('.categoryDescription').should("not.have.text", "")
            .then(cy.get('.categoryDescription').should("have.text", "Telefony tylko od najlepszych producentów!")));
    })
    ...
    it('"słuchawki" category should have its description visible', () => {
        ...
        cy.waitUntil(() => cy.get('.categoryDescription').should("not.have.text", "")
            .then(cy.get('.categoryDescription').should("have.text", "Oferujemy słuchawki nauszne jak i dokanałowe")));
    })
    ...
    it('"konsole" category should have its description visible', () => {
        ...
        cy.waitUntil(() => cy.get('.categoryDescription').should("not.have.text", "")
            .then(cy.get('.categoryDescription').should("have.text", "Konsole od producentów Sony (PlayStation) i Microsoft (Xbox)")));
    })
    ...
    it('"monitory" category should have its description visible', () => {
        ...
        cy.waitUntil(() => cy.get('.categoryDescription').should("not.have.text", "")
        .then(cy.get('.categoryDescription').should("have.text", "Szeroki wybór monitorów o różnych przekątnych, rozdzielczościach, częstotliwości odświeżania i nie tylko!")));
    })
    ...
    it('"Dodano do koszyka" alert dissapears after a while', () => {
        cy.get('.addToBasketButton').eq(0).click();
